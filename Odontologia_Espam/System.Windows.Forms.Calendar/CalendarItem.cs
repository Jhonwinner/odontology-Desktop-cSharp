...
namespace System.Windows.Forms.Calendar
{
        ...
        : CalendarSelectableElement
    {
        ...
        public CalendarItem(Calendar calendar, DateTime startDate, DateTime endDate, string text,int _idConsulta)
            : this(calendar)
        {
            StartDate = startDate;
            EndDate = endDate;
            Text = text;
            IdConsultasGeneral = _idConsulta; 
        ...
        /// <param name="text">Text of the item</param>
        public CalendarItem(Calendar calendar, DateTime startDate, TimeSpan duration, string text, int _idConsulta)
            : this(calendar, startDate, startDate.Add(duration), text, _idConsulta)
        { }
        ...
        public virtual int IdConsultasGeneral
        {
            get { return _numIDConsulta; }
            set { _numIDConsulta = value; }
        }
